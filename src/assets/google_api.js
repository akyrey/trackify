...
*/
  var g = this || self, h = "closure_uid_" + (1E9 * Math.random() >>> 0), aa = 0,
...
*/
  ...
  var q = window, t = document, ba = q.location, ca = function() {}, da = /\[native code\]/,
    y = function(a, b, c) {return a[b] = a[b] || c;}, ea = function(a) {
      a = a.sort();
  ...
  }, G = function(a) {return y(y(D, "H", z()), a, z());};
  var H = y(D, "perf", z()), I = y(H, "g", z()), ia = y(H, "i", z());
  y(H, "r", []);
  z();
  z();
  var L = function(a, b, c) {
    ...
    b && 0 < b.length && (b = M(b), c && 0 < c.length && (b += "___" + M(c)), 28 < b.length
    && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = y(ia, "_p", z()), y(b, c,
      z())[a] = (new Date).getTime(), L(a, "_p", c));
  }, M = function(a) {
    return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_");
  };
  var O = z(), P = [], R = function(a) {throw Error("Bad hint" + (a ? ": " + a : ""));};
  P.push(["jsl", function(a) {
    ...
    if (b = a.u) {
      a = y(D, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push(
        "http:" + b[1]);
    }
  }]);
  var ja = /^(\/[a-zA-Z0-9_\-]+)+$/, S = [/\/amp\//, /\/amp$/, /^\/amp$/],
    ka = /^[a-zA-Z0-9\-_\.,!]+$/, la = /^gapi\.loaded_[0-9]+$/, ma = /^[a-zA-Z0-9,._-]+$/,
    qa = function(a, b, c, d, e) {
      var f = a.split(";"), k = f.shift(), l = O[k], m = null;
      l ? m = l(f, b, c, d) : R("no hint processor for: " + k);
      m || R("failed to generate load url");
      b = m;
      c = b.match(na);
      (d = b.match(oa)) && 1 === d.length && pa.test(b) && c && 1 === c.length || R(
        "failed sanity: " + a);
      try {
        a = "?";
        if (e && 0 < e.length) {
          ...
          for (d = {}; c < e.length;) {
            ...
            f = "object" == k && null !=
            p || "function" == k ?
              "o" + (Object.prototype.hasOwnProperty.call(p, h) && p[h] || (p[h] = ++aa)) :
              (typeof p).charAt(0) + p;
      ...
      return [encodeURIComponent(a.pathPrefix).replace(/%2C/g,
        ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "",
        "/rt=j/sv=1/d=1/ed=1", a.g ? "/am=" + e(a.g) : "", a.i ? "/rs=" + e(a.i) : "",
        a.j ? "/t=" + e(a.j) : "", "/cb=", e(c)].join("");
    }, ra = function(a) {
      ...
      for (var d = 0, e = b.length; d < e; ++d) {
        var f = b[d].split("="), k = decodeURIComponent(f[0]), l =
    ...
    pa = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, oa = /\/cb=/g,
    na = /\/\//g, ta = function() {
      var a = E();
      if (!a) {
  ...
  var V = decodeURI("%73cript"), W = /^[-+_0-9\/A-Za-z]+={0,2}$/, X = function(a, b) {
    ...
    var a = D.nonce;
    return void 0 !== a ? a && a === String(a) && a.match(W) ? a : D.nonce = null :
      t.querySelector ? (a = t.querySelector("script[nonce]")) ?
        (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(W) ?
          D.nonce = a : D.nonce = null) : null : null;
  }, wa = function(a) {
    ...
    b.async = "true";
    (a = t.getElementsByTagName(V)[0]) ? a.parentNode.insertBefore(b, a) :
      (t.head || t.body || t.documentElement).appendChild(b);
  }, xa = function(a, b) {
    var c = b && b._c;
    if (c) {
    ...
    var d = c.h || ta(), e = y(D, "ah", z());
    if (e["::"] && b.length) {
      a = [];
      for (var f = null; f = b.shift();) {
        var k = f.split(".");
        k = e[f] || e[k[1] && "ns:" + k[0] || ""] || d;
        var l = a.length && a[a.length - 1] || null, m = l;
        l && l.hint == k || (m = { hint: k, features: [] }, a.push(m));
        m.features.push(f);
      }
      var p = a.length;
      if (1 < p) {
        var u = c.callback;
        u && (c.callback = function() {0 == --p && u();});
      }
      for (; b = a.shift();) {
        Aa(b.features, c, b.hint);
      }
    } else {
      Aa(b || [], c, d);
    }
    ...
    a = ea(a) || [];
    var d = b.callback, e = b.config, f = b.timeout, k = b.ontimeout, l = b.onerror, m = void 0;
    ...
    l = y(G(c), "r", []).sort();
    var F = y(G(c), "L", []).sort(), Fa = D.le, J = [].concat(l), fa = function(x, A) {
      if (u) {
        return 0;
      }
      q.clearTimeout(p);
      ...
      if (A) {
        N("me0", x, J);
        try {za(A, c, m);} finally {N("me1", x, J);}
      }
      return 1;
    };
    ...
    if (r.length) {
      ...
      v[w] = function(x) {
        ...
        0 < w && v[w - 1] ? v[w] = function() {A(B);} : A(B);
      };
      if (r.length) {
        var Q = "loaded_" + D.I++;
        C[Q] = function(x) {
  ...
  var Da = null, Z = g.trustedTypes;
  if (Z && Z.createPolicy) {
    try {
      Da = Z.createPolicy("gapi#gapi", { createHTML: n, createScript: n, createScriptURL: n });
    } catch (a) {g.console && g.console.error(a.message);}
  }
  Ca = Da;
  var Y = Ca;
  var ya = function(a, b) {
    if (D.hee && 0 < D.hel) {
      try {return a();} catch (c) {
        b && b(c), D.hel--, Ba("debug_error",
          function() {try {window.___jsl.hefn(c);} catch (d) {throw c;}});
      }
    } else {
  ...
  var Ea = C.load;
  Ea && y(D, "ol", []).push(Ea);
  C.load = function(a, b) {return ya(function() {return Ba(a, b);});};
